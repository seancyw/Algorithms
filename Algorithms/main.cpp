...
int main()
{
	testCase test = INTERPOLATION_SEARCH;
...
void interpolationSearchTest()
{
	std::cout << "Interpolation search test\n\n";
	...
	try {
		...
		//Get one of the value from the list
		bool exist = searchAlgorithms::interpolationSearchValue(intList, intList[10]);
		if (exist)
			std::cout << intList[10] << " is existed on the list\n";
		else
			std::cout << intList[10] << " is not existed on the list\n";
		...
		//Check for invalidate value
		randomValue = rand() % 500 + 1;
		exist = searchAlgorithms::interpolationSearchValue(intList, randomValue);
		...
		std::cout << "\n";
		//Get one of the value from the list
		int position = searchAlgorithms::interpolationSearchIndex(intList, intList[8]);
		if (position != -1)
			std::cout << intList[8] << " is on position " << position << " in list\n";
		else
			std::cout << intList[8] << " is not exist in list\n";
		...
		//Check for invalidate value
		randomValue = rand() % 500 + 1;
		position = searchAlgorithms::interpolationSearchIndex(intList, randomValue);
